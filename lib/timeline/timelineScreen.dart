...
import 'package:itaxi/widget/timelineSoonInfoCard.dart';
                  ...
                  if (snapshot.hasData) {
                    ...
                    if (snapshot.data!.isNotEmpty) {
                      return ListView(
                        children: [
                          Padding(
                            padding: EdgeInsets.fromLTRB(0.w, 48.h, 0.w, 0.h),
                            child: Text(
                              '타임라인',
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                for (int i = snapshot.data!.length - 1; i >= 0; i--)
                                  if (DateTime.now().difference(DateTime.parse(snapshot.data![i].deptTime!)).isNegative == true)
                                    Column(
                                      children: [
                                        if (i + 1 < snapshot.data!.length && DateTime.parse(DateFormat('yyyy-MM-dd').format(DateTime.parse(snapshot.data![i].deptTime!))).compareTo(DateTime.parse(DateFormat('yyyy-MM-dd').format(DateTime.parse(snapshot.data![i + 1].deptTime!)))) != 0)
                                          Row(
                                            children: [
                                              Text(
                                                DateFormat('M월 d일 E').format(DateTime.parse(snapshot.data![i].deptTime!)),
