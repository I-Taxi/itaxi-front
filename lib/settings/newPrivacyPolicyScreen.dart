...
class NewPrivacyPolicyScreen extends StatelessWidget {
  const NewPrivacyPolicyScreen({Key? key}) : super(key: key);
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    '* 사용자 모집\n'
                    '* 회원가입을 한 사용자는 모집방 생성, 채팅 등 아이택시 관련 기능을 이용할 수 있습니다.\n\n'
                    '■ 개인정보 수집 항목\n'
                    '회사는 회원가입, 서비스 신청을 위해 아래와 같은 개인정보를 수집하고 있습니다.\n'
                    '* 수집항목: 학번 이메일(한동 구글 이메일), 이름(한동 구글 계정), 전화번호\n'
                    '* 개인정보 수집방법: 앱 설치 시 회원가입 페이지에서 구글 이메일 인증 및 추가 정보 기입\n\n'
                    '제3자 제공시 제공받는 자의 성명, 제공받는 자의 이용 목적과 제공하는 항목\n'
                    '회사는 고객님의  정보를 제 3자에게 제공하지 않습니다. 개인정보를 ‘개인정보의 수집 및 활용 목적, 수집하는 개인정보 항목’에서 고지한 범위 내에서 활용하며, 동 범위를 초과하여 이용하거나 타인 또는 타 기업, 기관에 제공하지 않습니다.\n\n'
