...
class NewMyInfoScreen extends StatefulWidget {
  const NewMyInfoScreen({Key? key}) : super(key: key);

  @override
  _NewMyInfoScreenState createState() => _NewMyInfoScreenState();
}

class _NewMyInfoScreenState extends State<NewMyInfoScreen> {
