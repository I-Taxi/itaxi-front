...
class NewTimelineScreen extends StatelessWidget {
  const NewTimelineScreen({Key? key}) : super(key: key);
                                ...
                                if (DateTime.now()
                                  ...
                                  Column(
                                    children: [
                                      ...
                                      soonTimelineListTile( //soonTimelineListTile을 수정해야 함.
                                        context: context,
                    ...
                    return ListView(
                      children: [
                        ...
                        OutlinedButton(
                            ...
                            child: Text(
                              "동료 구하러 가기",
                              style: textTheme.headline1?.copyWith(color: colorScheme.secondary, fontWeight: FontWeight.w500, fontSize: 20),
                            ),
                          style: OutlinedButton.styleFrom(
                            side: BorderSide(width: 5.0, color: colorScheme.secondary)
                          ),
                        )
                      ],
                    );
