...
class NewMainScreenGather extends StatefulWidget {
  const NewMainScreenGather({Key? key}) : super(key: key);

  @override
  State<NewMainScreenGather> createState() => _NewMainScreenGatherState();
}

class _NewMainScreenGatherState extends State<NewMainScreenGather> {
